 ...
 */
public class PatternTimesAllowCombinations {
    public static void main(String[] args) {
        ...
        Pattern<WaterSensor, WaterSensor> times2 = pattern.times(2).allowCombinations();

        // TODO 2、在流上应用模式
        PatternStream<WaterSensor> waterSensorPs = CEP.pattern(waterSensorStream, times2);
        // TODO 3、获取匹配到的结果
        waterSensorPs
